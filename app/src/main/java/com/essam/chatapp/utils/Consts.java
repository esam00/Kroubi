...
public class Consts {
    ...
    public static final int EDIT_PHOTO_REQUEST =3;
    public static final int READ_CONTACTS_REQUEST =4;
    public static final int DISPLAY_CONTACTS_ACTIVITY =5;
    ...
    public static final String DEFAULT_NOTIFICATION_CHANNEL_ID = "kroubi_channel";
    public static final int NEW_MESSAGE_NOTIFICATION_ID = 20;
}
